...
# Vorbereiten des initialen Prompts
    ...
    # Konvertieren der Daten in einen lesbaren String
        ...
        initial_prompt = f"""Based on the user persona ({persona_str}) and company data ({company_str}), please create engaging and optimized ad copy and designs for Zalando's advertising banners."""
